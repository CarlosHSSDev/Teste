...
const { Client, LocalAuth, sessionData } = require('whatsapp-web.js');
const qrcode = require('qrcode-terminal');

const app = express();
const PORT = process.env.PORT || 3000; // Usa a porta fornecida pelo Heroku ou 3000 como padrão

// Rota de exemplo do servidor Express
app.get('/', (req, res) => {
  res.send('Olá, mundo!');
});
